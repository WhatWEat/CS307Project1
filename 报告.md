...
|      | 1               | 2                | 3                | 4                | 5                |
|------|-----------------|------------------|------------------|------------------|------------------|
| 平均速度 | 7257  records/s | 13259  records/s | 44298  records/s | 42272  records/s | 45230  records/s |

接下来，我们按照如下数据量作为基准进行了五次实验

|    | Author          | Post             | City             | Category         | Reply            | SubReply |
|----|-----------------|------------------|------------------|------------------|------------------|----------|
| 数量 | 100000 | 10000 | 1000 | 2000 | 20000 |  50000        |

由于方法一速度过慢，第二次实验开始未参与

| 数据量  |         | 1                          | 2                                 | 3                | 4               | 5                         |
|------|---------|----------------------------|-----------------------------------|------------------|-----------------|---------------------------|
| 一倍基准 | 时间/平均速度 | 186841ms<br/>7111records/s | 105733ms<br/>12565records/s | 31375ms<br/>42347records/s | 32405ms<br/> 41000records/s | 32734ms<br/>40589record/s |
| 二倍基准 | 时间/平均速度 | /                          |                                   |                  |                 |                           |
| 三倍基准 | 时间/平均速度 | /                          |                                   |                  |                 |                           |
| 四倍基准 | 时间/平均速度 | /                          |                                   |                  |                 |                           |
| 五倍基准 | 时间/平均速度 | /                          |                                   |                  |                 |                           |
